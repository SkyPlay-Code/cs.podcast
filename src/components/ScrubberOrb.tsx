...
const GoldenSphere: React.FC<GoldenSphereProps> = ({ 
  ...
  const goldGradient = `radial-gradient(circle at 35% 35%, #FFFDE4 5%, #FF золотоD700 30%, #D4AF37 60%, #B8860B 100%)`; // золото is a common term for gold, if FF золотоD700 isn't a valid hex, use FFD700. Assume FFD700
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        height: sphereSize,
        borderRadius: '50%',
        background: `radial-gradient(circle at 35% 35%, #FFFDE4 5%, #FFD700 30%, #D4AF37 60%, #B8860B 100%)`, // 3D Gold
